...
<form class="form-horizontal form-validate discount-form" id="adminForm" action="" method="post"  enctype="multipart/form-data">
       <div class="add-on after" style="height: 40px;padding: 10px;"> 
          ...
          if(!isset($discountVal->is_use_discount_code)){
            ...
            <span id="use_discount_code_div" style="margin-bottom: 20px;margin-top: 20px;"> 
   
        <div class="control-group">
            <label class="span1 hasTip" for="title"  title="Discount Limit">Discount Limit:</label>
            <div class="controls">
            <input type="text" placeholder="Discount Limit" id="discount_limit" name="discount_limit" value="<?php echo @$discountVal->discount_limit; ?>" style="width: 200px;">
            </div>
        </div> 
         ...
         <div class="control-group">
            ...
            <div class="controls">
            <input type="text" placeholder="Discount Code" id="discount_code" name="discount_code" value="<?php echo @$discountVal->discount_code; ?>" style="width: 200px;">
            </div>
        </div>  
        ...
        <div  style="float: left; width: 384px;">
            ...
            <div class="controls" style="margin-left: 35px;">
              <span data-bind="shop | money_symbol" data-showif="discount.isFixed" class="add-on before" id="fixed_amount" style="border-radius: 5px 0px 0px 5px;display: inline-block;height: 44px;margin-right: -5px;vertical-align: middle;line-height: 30px;margin-top: -2px;"><?php echo $currencysymbol;?></span>
        ...
        ?>
         <div class="control-group" style="clear: both;">
            ...
            <div class="controls">
            <input type="text" placeholder="Start Date" id="start_date" name="start_date" value="<?php echo $start_date;?>" style="width: 200px;">
       ...
       ?>
          <div class="control-group">
            ...
            <label class="pointer inline fw-normal" for="coupon-never-expires">
                <span class="add-on after"  style="margin-left: -4px;height: 28px;margin-top: -11px;line-height: 22px;">
