...
if($is_super_admin==''){
 ...
 ?>
<h3>Schedule</h3>
<form class="form-horizontal form-validate vlcr_class_schedule" id="adminForm" action="" method="post"  enctype="multipart/form-data">
    <div class="control-group">
     ...
     <div class="control-group" style="line-height: 40px;">
            ...
            <div class="controls">
            <input type="text" placeholder="Date" id="datepicker" name="date" value="<?php echo @esc_html($classVal->date)?>" style="width: 150px;">
        ...
        <div class="control-group" style="line-height: 40px;">
            ...
            <div class="controls">
            <input type="text" data-format="hh:mm A" placeholder="From" id="class_start_time" name="start_time" value="<?php echo @esc_html($classVal->start_time)?>" style="width: 150px;">
        ...
        <div class="control-group" style="line-height: 40px;">
            ...
            <div class="controls">
            <input type="text" data-format="hh:mm A" placeholder="To" id="class_end_time" name="end_time" value="<?php echo @esc_html($classVal->end_time)?>" style="width: 150px;">
...
<div class="control-group weeklytotaldays">
        ...
        <label class="control-label" style="float: left; text-align: left; margin-left: 20px; width: 129px;">Ends:</label>
            <div class="controls" style="margin-left: 200px;">
                ...
                <div class="input-append">
                    <input type="text" class="span3" value="<?php echo (@$classVal->end_classes_count) ? @$classVal->end_classes_count : ''?>" name="end_classes_count" id="recurring_endclasses" style="width: 80px;margin: 0;">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input type="text" placeholder="Max. attendees" id="seat_attendees" name="seat_attendees" value="<?php echo isset($classVal->seat_attendees) ? @$classVal->seat_attendees : @$plan->max_attendees; ?>" style="width: 100px;">
            <input type="hidden" id="max_seat_attendees" value="<?php echo @esc_html($plan->max_attendees); ?>" >
            </div>
        </div>
        <div>
        <input type="hidden" name="created_by"  id="created_by"  value="<?php echo $current_user->ID;?>" />
