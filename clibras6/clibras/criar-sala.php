...
--> 
    ...
    <form id="createRoom" method="post">
     ...
     <!-- <script src='http://200.17.210.85/wpwebrtc/wp-content/themes/clibras/js/criaroom.js'></script>  -->
...
<?php 
    ...
    if(isset($_POST['criar-sala-virtual'])){
        ...
        $room = $_POST["sessionInput"];
        if($room==NULL){
            $str = '0123456789-abcdefghiklmnopqrstuvwxyz';
            $room = str_shuffle($str);
    
        }

        $url="localhost/sala-chat/?room=$room";
